...
```{r}
FitModel_ds9 <- function(db, ts.col, ic.col, 
...
```{r}
FitModel_ds9(db = ds9, ts.col = 2, ic.col = 1)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 3, ic.col = 2)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 4, ic.col = 3)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 5, ic.col = 4)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 6, ic.col = 5)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 7, ic.col = 6)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 8, ic.col = 7)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 9, ic.col = 8)
```
...
```{r}
#FitModel_ds9(db = ds9, ts.col = 10, ic.col = 9)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 11, ic.col = 10)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 12, ic.col = 11)
```
...
```{r}
#FitModel_ds9(db = ds9, ts.col = 13, ic.col = 12)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 14, ic.col = 13)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 15, ic.col = 14)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 16, ic.col = 15)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 17, ic.col = 16)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 18, ic.col = 17)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 19, ic.col = 18)
```
...
```{r}
#FitModel_ds9(db = ds9, ts.col = 20, ic.col = 19)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 21, ic.col = 20)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 22, ic.col = 21)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 23, ic.col = 22)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 24, ic.col = 23)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 25, ic.col = 24)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 26, ic.col = 25)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 27, ic.col = 26)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 28, ic.col = 27)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 29, ic.col = 28)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 30, ic.col = 29)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 31, ic.col = 30)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 32, ic.col = 31)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 33, ic.col = 31)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 34, ic.col = 33)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 35, ic.col = 34)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 36, ic.col = 35)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 37, ic.col = 36)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 38, ic.col = 37)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 39, ic.col = 38)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 40, ic.col = 39)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 41, ic.col = 40)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 42, ic.col = 41)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 43, ic.col = 42)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 44, ic.col = 43)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 45, ic.col = 44)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 46, ic.col = 45)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 47, ic.col = 46)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 48, ic.col = 47)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 49, ic.col = 48)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 50, ic.col = 49)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 51, ic.col = 50)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 52, ic.col = 51)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 53, ic.col = 52)
```
...
```{r}
#FitModel_ds9(db = ds9, ts.col = 54, ic.col = 53)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 55, ic.col = 54)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 56, ic.col = 55)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 57, ic.col = 56)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 58, ic.col = 57)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 59, ic.col = 58)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 60, ic.col = 59)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 61, ic.col = 60)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 62, ic.col = 61)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 63, ic.col = 62)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 64, ic.col = 63)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 65, ic.col = 64)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 66, ic.col = 65)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 67, ic.col = 66)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 68, ic.col = 67)
```
...
```{r}
#FitModel_ds9(db = ds9, ts.col = 69, ic.col = 68)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 70, ic.col = 69)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 71, ic.col = 70)
```
...
```{r}
#FitModel_ds9(db = ds9, ts.col = 72, ic.col = 71)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 73, ic.col = 72)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 74, ic.col = 73)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 75, ic.col = 74)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 76, ic.col = 75)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 77, ic.col = 76)
```
...
```{r}
FitModel_ds9(db = ds9, ts.col = 78, ic.col = 77)
```
