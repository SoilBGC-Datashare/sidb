...
Crow_V36=modelFitTS(db = db[[9]], ts.col = 36, ic.col = 35, unitConverter = 1e3,
               inipars=list(oneP=0.5,
                            ...
                            feedback=c(0.01, 0.0001, 0.1, 0.01, 0.1)))
##
Crow_V37=modelFitTS(db = db[[9]], ts.col = 37, ic.col = 36, unitConverter = 1e3,
               inipars=list(oneP=0.5,
                            parallel=c(0.01, 0.001, 0.1),
                            series=c(0.05, 0.0001, 0.01, 0.1),
                            feedback=c(0.01, 0.0001, 0.1, 0.01, 0.1)) )
...
Sierra_V10=modelFitTS(db = db[[24]], ts.col = 10, ic.col = 1, unitConverter = 0.01, 
                      inipars=list(oneP=0.1,
                                   parallel=c(0.1, 0.01, 0.1),
...
Sierra_V12=modelFitTS(db = db[[24]], ts.col = 12, ic.col = 1, unitConverter = 0.01, 
                      inipars=list(oneP=0.01,
...
Sierra_V14=modelFitTS(db = db[[24]], ts.col = 14, ic.col = 1, unitConverter = 0.01, 
                      inipars=list(oneP=0.01,
                                   parallel=c(0.5, 0.005, 0.5),
                                   series=c(0.05, 0.005, 0.05, 0.5),
                                   feedback=c(0.05, 0.005, 0.005, 0.05, 0.5)))
...
Sierra_V16=modelFitTS(db = db[[24]], ts.col = 16, ic.col = 1, unitConverter = 0.01, 
                      inipars=list(oneP=0.01,
                                   parallel=c(0.5, 0.005, 0.5),
                                   series=c(0.05, 0.005, 0.05, 0.5),
                                   feedback=c(0.05, 0.005, 0.005, 0.05, 0.5)))

Sierra_V17=modelFitTS(db = db[[24]], ts.col = 17, ic.col = 1, unitConverter = 0.01, 
                      inipars=list(oneP=0.01,
                                   parallel=c(0.5, 0.005, 0.5),
                                   series=c(0.05, 0.005, 0.05, 0.5),
                                   feedback=c(0.05, 0.005, 0.005, 0.05, 0.5)))
...
#Winkler_V2=modelFitTS(db = db[[30]], ts.col = 2, ic.col = 1, unitConverter = 1)
#Winkler_V3=modelFitTS(db = db[[30]], ts.col = 3, ic.col = 3, unitConverter = 1)
#Winkler_V4=modelFitTS(db = db[[30]], ts.col = 4, ic.col = 2, unitConverter = 1)

Winkler_V5=modelFitTS(db = db[[30]], ts.col = 5, ic.col = 1, unitConverter = 1, 
                      inipars=list(oneP=0.1,
                                   parallel=c(0.01, 0.001, 0.1), 
                                   series=c(0.01, 0.0001, 0.01, 0.5), 
                                   feedback=c(0.01, 0.0001, 0.01, 0.01, 0.5)))

Winkler_V6=modelFitTS(db = db[[30]], ts.col = 6, ic.col = 3, unitConverter = 1, 
                      inipars=list(oneP=0.01,
                                   parallel=c(0.5, 0.05, 0.5), 
                                   series=c(0.05, 0.0005, 0.01, 0.5), 
                                   feedback=c(0.01, 0.001, 0.1, 0.01, 0.5)))

Winkler_V7=modelFitTS(db = db[[30]], ts.col = 7, ic.col = 2, unitConverter = 1, 
                      inipars=list(oneP=0.01,
                                   parallel=c(0.01, 0.001, 0.1), 
                                   series=c(0.01, 0.0001, 0.01, 0.1), 
                                   feedback=c(0.01, 0.0001, 0.01, 0.01, 0.1)))

Winkler_V8=modelFitTS(db = db[[30]], ts.col = 8, ic.col = 1, unitConverter = 0.1, 
                      inipars=list(oneP=0.05,
                                   parallel=c(0.01, 0.001, 0.1), 
                                   series=c(0.01, 0.0001, 0.01, 0.1), 
                                   feedback=c(0.01, 0.0001, 0.01, 0.01, 0.1)))
Winkler_V9=modelFitTS(db = db[[30]], ts.col = 9, ic.col = 3, unitConverter = 1,
                      inipars=list(oneP=0.05,
                                   parallel=c(0.01, 0.001, 0.1), 
                                   series=c(0.01, 0.0001, 0.01, 0.1), 
                                   feedback=c(0.01, 0.0001, 0.01, 0.01, 0.1)))
Winkler_V10=modelFitTS(db = db[[30]], ts.col = 10, ic.col = 2, unitConverter = 1,
                       inipars=list(oneP=0.05,
                                    parallel=c(0.01, 0.001, 0.1), 
                                    series=c(0.01, 0.0005, 0.01, 0.1), 
                                    feedback=c(0.01, 0.0001, 0.01, 0.01, 0.1)))
