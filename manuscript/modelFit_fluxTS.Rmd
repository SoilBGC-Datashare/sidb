...
```{r, results='hide'}
identical(as.character(db[[19]]$initConditions[5, 'site']), as.character(db[[19]]$variables$V5$site))
identical(as.character(db[[19]]$initConditions[5, 'vegetation']), as.character(db[[19]]$variables$V5$vegetation))
