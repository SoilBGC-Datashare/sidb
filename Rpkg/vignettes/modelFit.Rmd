...
Thre three-pool series model shows the better fit to the data according to the sum squared residual and the mean squared error statistics.
However, according to the Akaike information criterion (AIC), the two-pool model with parallel structure is the most parsimoniuos model (lowest AIC), which is a compromise between number of parameters to fit and goodnes of fit. 
